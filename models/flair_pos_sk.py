...
create_sk_text('../data/shipibo.conllu', '../data/shipibo_train.txt', sep = False)
create_sk_text('../data/shipibo_dev.conllu', '../data/shipibo_dev.txt', sep = False)
create_sk_text('../data/shipibo_test.conllu', '../data/shipibo_test.txt', sep = False)
